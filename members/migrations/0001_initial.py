    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(help_text='Local number only, without country code (8-11 digits).', max_length=11, unique=True)),
                ('country_code', models.CharField(max_length=5)),
                ('phone_number', models.CharField(blank=True, editable=False, max_length=20, null=True, unique=True)),
